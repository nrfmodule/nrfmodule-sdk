...
/**
 * @brief Sends data in AT command datamode.
 *
 * This function transmits a buffer of data using the modem's AT datamode interface.
 *
...
int nrf_modem_at_client_init(void);


int nrf_modem_at_sleep(void);
